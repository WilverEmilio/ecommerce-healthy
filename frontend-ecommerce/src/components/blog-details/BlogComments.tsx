            ...
            <div className="latest-comments">
                <ul>
                    <li>
                        <div className="comments-box">
                            <div className="comments-avatar">
                                <Image src={authorOne} style={{ width: "auto", height: "auto" }} alt="image not found" />
                            </div>
                    ...
                    <li>
                        <div className="comments-box">
                            <div className="comments-avatar">
                                <Image src={authorTwo} style={{ width: "auto", height: "auto" }} alt="image not found" />
                            </div>
                            <div className="comments-text"> authorTwo
                                <div className="avatar-name">
