...
import DetailsImg from '../../../public/assets/img/gallery/gallery-custom/4.jpg';
import DetailsBgImg from '../../../public/assets/img/gallery/gallery-custom/3.jpg';
...
const GalleryDetailsTwo = ({ id }: idType) => {
    const gallaryData: any = gallary_data.find((item) => item.id == id)
    return (
        <>
            <Breadcrumb title='Gallary Details-2' subTitle='Gallary Details' />
...
export default GalleryDetailsTwo;