                            ...
                            <div className="tab-content mb-60">
                                ...
                                >
                                    <div className="terms_conditions_content">
                                        ...
                                        <p>
                                            As a provider of the Zomata – React Next.js Organic Food Template you may collect and{" "}
                                ...
                                >
                                    <div className="terms_conditions_content">
                                        ...
                                        <ul className="icon_list unordered_list_block">
                                            <li>
                                                <span className="list_item_text">
                                                    <strong>1. Abusive users</strong>: Terms and Conditions
                                            ...
                                            <li>
                                                <span className="list_item_text">
                                                    <strong>2. Intellectual property theft</strong>:
                                            ...
                                            <li>
                                                <span className="list_item_text">
                                                    <strong> 3. Potential litigation:</strong> If a user
